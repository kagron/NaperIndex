...
!function (m) {
  var u = [],
      t = { options: { prependExistingHelpBlock: !1, sniffHtml: !0, preventSubmit: !0, submitError: !1, submitSuccess: !1, semanticallyStrict: !1, autoAdd: { helpBlocks: !0 }, filter: function filter() {
        return !0;
      } }, methods: { init: function init(a) {
        var v = m.extend(!0, {}, t);v.options = m.extend(!0, v.options, a);var e = m.unique(this.map(function () {
          return m(this).parents("form")[0];
        }).toArray());return m(e).bind("submit", function (a) {
          var e = m(this),
              i = 0,
              t = e.find("input,textarea,select").not("[type=submit],[type=image]").filter(v.options.filter);t.trigger("submit.validation").trigger("validationLostFocus.validation"), t.each(function (a, e) {
            var t = m(e).parents(".form-group").first();t.hasClass("warning") && (t.removeClass("warning").addClass("error"), i++);
          ...
          var l = m(this),
              ...
              n = [];if (!i.length && v.options.autoAdd && v.options.autoAdd.helpBlocks && (i = m('<div class="help-block" />'), t.find(".controls").append(i), u.push(i[0])), v.options.sniffHtml) {
            var a = "";if (void 0 !== l.attr("pattern") && (a = "Not in the expected format\x3c!-- data-validation-pattern-message to override --\x3e", l.data("validationPatternMessage") && (a = l.data("validationPatternMessage")), l.data("validationPatternMessage", a), l.data("validationPatternRegex", l.attr("pattern"))), void 0 !== l.attr("max") || void 0 !== l.attr("aria-valuemax")) {
              var e = void 0 !== l.attr("max") ? l.attr("max") : l.attr("aria-valuemax");a = "Too high: Maximum of '" + e + "'\x3c!-- data-validation-max-message to override --\x3e", l.data("validationMaxMessage") && (a = l.data("validationMaxMessage")), l.data("validationMaxMessage", a), l.data("validationMaxMax", e);
            }if (void 0 !== l.attr("min") || void 0 !== l.attr("aria-valuemin")) {
              var o = void 0 !== l.attr("min") ? l.attr("min") : l.attr("aria-valuemin");a = "Too low: Minimum of '" + o + "'\x3c!-- data-validation-min-message to override --\x3e", l.data("validationMinMessage") && (a = l.data("validationMinMessage")), l.data("validationMinMessage", a), l.data("validationMinMin", o);
            ...
            var t = a.replace(/([A-Z])/g, ",$1").split(",");"validation" === t[0] && t[1] && n.push(t[1]);
            ...
            if (void 0 !== l.data("validation" + e + "Shortcut")) m.each(l.data("validation" + e + "Shortcut").split(","), function (a, e) {
              ...
              var t = v.builtInValidators[e.toLowerCase()];"shortcut" === t.type.toLowerCase() && m.each(t.shortcut.split(","), function (a, e) {
                e = g(e), d.push(e), n.push(e);
              });
            }
          }), 0 < (s = d).length;) {}var c = {};m.each(n, function (a, t) {
            var i = l.data("validation" + t + "Message"),
                e = void 0 !== i,
                n = !1;if (i = i || "'" + t + "' validation failed \x3c!-- Add attribute 'data-validation-" + t.toLowerCase() + "-message' to input to change this message --\x3e", m.each(v.validatorTypes, function (a, e) {
              void 0 === c[a] && (c[a] = []), n || void 0 === l.data("validation" + t + g(e.name)) || (c[a].push(m.extend(!0, { name: g(e.name), message: i }, e.init(l, t))), n = !0);
            }), !n && v.builtInValidators[t.toLowerCase()]) {
              var o = m.extend(!0, {}, v.builtInValidators[t.toLowerCase()]);e && (o.message = i);var r = o.type.toLowerCase();"shortcut" === r ? n = !0 : m.each(v.validatorTypes, function (a, e) {
            ...
            var i = h(l),
                n = [];return m.each(c, function (t, a) {
            ...
            var e = h(l),
                o = [];t.find("input,textarea,select").each(function (a, e) {
              var t = o.length;if (m.each(m(e).triggerHandler("validation.validation", n), function (a, e) {
                o.push(e);
              }), o.length > t) m(e).attr("aria-invalid", "true");else {
                var i = l.data("original-aria-invalid");m(e).attr("aria-invalid", void 0 !== i && i);
              }
        ...
        return this.each(function () {
          var a = m(this),
              ...
              t = e.find(".help-block").first();a.unbind(".validation"), t.html(t.data("original-contents")), e.attr("class", e.data("original-classes")), a.attr("aria-invalid", a.data("original-aria-invalid")), t.attr("role", a.data("original-role")), -1 < u.indexOf(t[0]) && t.remove();
        });
      }, collectErrors: function collectErrors(a) {
        var o = {};return this.each(function (a, e) {
          var t = m(e),
              i = t.attr("name"),
              n = t.triggerHandler("validation.validation", { includeEmpty: !0 });o[i] = m.extend(!0, n, o[i]);
        }), m.each(o, function (a, e) {
          0 === e.length && delete o[a];
        }), o;
      }, hasErrors: function hasErrors() {
        var t = [];return this.each(function (a, e) {
          t = t.concat(m(e).triggerHandler("getValidators.validation") ? m(e).triggerHandler("validation.validation", { submitting: !0 }) : []);
        }), 0 < t.length;
      }, override: function override(a) {
        t = m.extend(!0, t, a);
      } }, validatorTypes: { callback: { name: "callback", init: function init(a, e) {
        ...
        } }, ajax: { name: "ajax", init: function init(a, e) {
          ...
          return "" + t.lastValue == "" + a && !0 === t.lastFinished ? !1 === t.lastValid : (!0 === t.lastFinished && (t.lastValue = a, t.lastValid = !0, t.lastFinished = !1, m.ajax({ url: t.url, data: "value=" + a + "&field=" + e.attr("name"), dataType: "json", success: function success(a) {
        ...
        }, blockSubmit: !0 }, max: { name: "max", init: function init(a, e) {
        ...
        } }, min: { name: "min", init: function init(a, e) {
        ...
        }, blockSubmit: !0 }, minchecked: { name: "minchecked", init: function init(a, e) {
          var t = a.parents("form").first().find('[name="' + a.attr("name") + '"]');return t.bind("click.validation", function () {
            a.trigger("change.validation", { includeEmpty: !0 });
    ...
    return a.toLowerCase().replace(/(^|\s)([a-z])/g, function (a, e, t) {
      ...
      h = function h(a) {
    var e = a.val(),
        t = a.attr("type");return "checkbox" === t && (e = a.is(":checked") ? e : ""), "radio" === t && (e = 0 < m('input[name="' + a.attr("name") + '"]:checked').length ? e : ""), e;
  };m.fn.jqBootstrapValidation = function (a) {
    return t.methods[a] ? t.methods[a].apply(this, Array.prototype.slice.call(arguments, 1)) : "object" != (typeof a === "undefined" ? "undefined" : _typeof(a)) && a ? (m.error("Method " + a + " does not exist on jQuery.jqBootstrapValidation"), null) : t.methods.init.apply(this, arguments);
